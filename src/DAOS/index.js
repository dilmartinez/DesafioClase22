...
switch ("json") {
  case "json":
    ...
    const { default: MensajesDaoArchivo } = await import(
      "./mensajes/MensajesDaoArchivo.js"
    );
...
//     );
//     const { default: MensajesDaoSQLite3 } = await import(
//       "./mensajes/MensajesDaoSQLite3.js.js"
//     );
