...
// Selecciono el formulario completo y hacemos un preventDefault
...
socket.on("message", (mensajesN) => {
  // Denormalizamos los mensajes recibidos por el socket y los integramos al html
  let mensajesDenormalized = normalizr.denormalize(
    mensajesN.result,
    [mensajeSchema],
    mensajesN.entities
  );
